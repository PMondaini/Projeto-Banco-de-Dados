...
,(4, 3, 7, 'Janela Indiscreta', 'Em Greenwich Village, Nova York, L.B. Jeffries (James Stewart), um fotógrafo profissional, está confinado em seu apartamento por ter quebrado a perna enquanto trabalhava.', 19540804, 6720)
...
,(8, 4, 3, 'Apocalypse Now', 'O Capitão Willard recebe a missão de encontrar e matar o comandante das Forças Especiais, Coronel Kurtz (Marlon Brando), que aparentemente enlouqueceu e se refugiou nas selvas do Camboja.',  19790510, 9180)
,(4, 1, 8, 'Indiana Jones e os Caçadores da Arca Perdida', 'Em 1936, o arqueólogo Indiana Jones (Harrison Ford) é contratado para encontrar a Arca da Aliança, que segundo as escrituras bíblicas conteria “Os Dez Mandamentos”.', 19811225, 6900)
...
,(1, 5, 1, 'Bonnie e Clyde - Uma Rajada de Balas','Durante a era da Grande Depressão, Bonnie (Faye Dunaway) e Clyde (Warren Beatty) são dois jovens que se conhecem de forma inusitada.',19670911,6660)
...
,(4, 1, 10, 'Apertem os Cintos… O Piloto SumiuApertem os Cintos… O Piloto Sumiu','O piloto Ted Striker (Robert Hays), ex-combatente de guerra, é forçado a assumir os controles de um avião quando a tripulação sucumbe à comida contaminada.',19801226,5220)
,(8, 4, 9, 'Seven - Os Sete Crimes Capitais','Dois policiais, om jovem e impetuoso David Mills (Brad Pitt) e o outro maduro e prestes a se aposentar, William Somerset (Morgan Freeman), são encarregados de uma periogosa investigação.',19951215,7560)
...
,(9, 2, 3, 'O Resgate do Soldado Ryan','Ao desembarcar na Normandia, no dia 6 de junho de 1944, capitão Miller (Tom Hanks) recebe a missão de comandar um grupo do batalhão para o resgate do soldado James Ryan, caçula de quatro irmãos, dentre os quais três morreram em combate.',19980911,9780)
,(4, 4, 2, 'Forrest Gump: O Contador de Histórias','Quarenta anos da história dos Estados Unidos, vistos pelos olhos de Forrest Gump (Tom Hanks), um rapaz com QI abaixo da média e boas intenções. Por obra do acaso, ele consegue participar de momentos cruciais.',19940706,8520)
,(6, 4, 3, 'Coração Valente','No século XIII, soldados ingleses matam a mulher do escocês William Wallace, bem na sua noite de núpcias. Para vingar a amada, ele resolve liderar seu povo em uma luta contra o cruel Rei inglês Edward  (Patrick McGoohan).',19940714,9900)
...
,(8, 1, 2, 'A Noviça Rebelde','No final da década de 1930, na Áustria, quando o pesadelo nazista estava prestes a se instaurar no país, uma noviça (Julie Andrews) que vive em um convento mas não consegue seguir as rígidas normas de conduta das religiosas.',19650302,10500)
,(6, 2, 8, 'A Princesa Prometida','Um avô lê um conto de fadas ao seu neto, com direito a uma linda princesa, lutas de esgrima e gigantes. A história do livro se baseia na vida da princesa Buttercup (Robin Wright), que é apaixonada por um jovem camponês.',19880129,5880)
,(5, 5, 3, 'Clube da Luta','Jack (Edward Norton) é um executivo jovem, trabalha como investigador de seguros, mora confortavelmente, mas ele está ficando cada vez mais insatisfeito com sua vida medíocre. Para piorar ele está enfrentando uma terrível crise de insônia.',19991015,9060)
...
,(6,4,8,'Quase Famosos','um adolescente de 15 anos, tem a chance realizar seu sonho acompanhando a turnê da banda Stillwater como jornalista. Sua mãe superprotetora acredita que o mundo do rock é dominado por drogas e sexo, mas as matérias do garoto chamam a atenção da revista Rolling Stone, que o convida a viajar com o grupo.',20010323 ,7320)
